...
const ProgramDetailsIcon: React.FC<{ className?: string }> = ({ className = "h-12 w-12 mb-4" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="url(#icon-gradient)" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12h6m-6 4h6m2 5H7a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h5.586a1 1 0 0 1 .707.293l5.414 5.414a1 1 0 0 1 .293.707V19a2 2 0 0 1-2-2Z" />
    </svg>
);

const ProxyIcon: React.FC<{ className?: string }> = ({ className = "h-12 w-12 mb-4" }) => (
    <svg xmlns="http://www.w3.org/2000/svg" className={className} fill="none" viewBox="0 0 24 24" stroke="url(#icon-gradient)" strokeWidth={1.5}>
...
const FundPortalPage: React.FC<FundPortalPageProps> = ({ navigate, user }) => {
  ...
  const portalTiles: PortalTile[] = [
    ...
    },
    {
      ...
      icon: <TicketingIcon className="h-9 w-9 sm:h-12 sm:w-12 mb-2 sm:mb-4" />,
    },
    {
      key: 'programDetails',
      title: 'Details',
      onClick: () => navigate('programDetails'),
      icon: <ProgramDetailsIcon className="h-9 w-9 sm:h-12 sm:w-12 mb-2 sm:mb-4" />,
    },
    {
      key: 'proxy',
      title: 'Proxy',
      onClick: () => navigate('proxy'),
      icon: <ProxyIcon className="h-9 w-9 sm:h-12 sm:w-12 mb-2 sm:mb-4" />,
    },
    {
      key: 'tokenUsage',
      title: 'Tokens',
      onClick: () => navigate('tokenUsage'),
      icon: <TokenUsageIcon className="h-9 w-9 sm:h-12 sm:w-12 mb-2 sm:mb-4" />,
    },
  ];
  ...
  return (
    <div className="flex-1 flex flex-col p-4 md:p-8">
      <div className="max-w-5xl mx-auto w-full">
        ...
        <div className="grid grid-cols-2 gap-3 sm:gap-6 w-full mt-12 max-w-md sm:max-w-2xl mx-auto">
          <IconDefs />
