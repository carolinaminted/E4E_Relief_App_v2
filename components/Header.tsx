  ...
  return (
    <header className="flex md:hidden items-center justify-between w-full h-20 bg-[#003a70] px-4 flex-shrink-0 z-30">
      ...
      <div className="relative" ref={dropdownRef}>
        ...
        >
          <span className="text-base truncate">Welcome, {userName}</span>
        ...
        {isDropdownOpen && (
          <div className="absolute right-0 mt-2 w-full bg-[#004b8d] border border-[#005ca0] rounded-md shadow-lg z-50 py-1">
            <button
              onClick={() => {
                onLogout();
