                ...
                <button type="button" onClick={() => toggleSection('lifetime')} className="w-full flex justify-between items-center text-left p-4" aria-expanded={openSections.lifetime}>
                    ...
                    <div className="flex items-center gap-4">
                        <button 
                            ...
                            className="bg-[#004b8d] hover:bg-[#005ca0] text-white font-semibold py-1 px-3 rounded-md text-sm transition-colors duration-200 disabled:bg-gray-700 disabled:text-gray-400 disabled:cursor-not-allowed border border-[#005ca0]"
